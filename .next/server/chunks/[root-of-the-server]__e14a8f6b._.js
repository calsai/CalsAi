...
const token = "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";
...
async function callGitHubAIForNaturalChat(message, detectedFoods, userProfile) {
    if ("TURBOPACK compile-time falsy", 0) //TURBOPACK unreachable
    ;
    const naturalPrompt = `
Tu ești Alex, un nutriționist prietenos și empatic care vorbește cu ${userProfile?.full_name || "prietenul tău"}. 
...
- Obiectiv: ${userProfile.goal === "lose" ? "să slăbească" : userProfile.goal === "gain" ? "să se îngrașe" : "să se maintină"}
- Calorii zilnice recomandate: ${userProfile.daily_calorie_goal || "necalculate"} cal
` : ""}
...
`;
    try {
        const client = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$azure$2d$rest$2f$ai$2d$inference$2f$dist$2f$esm$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"])(endpoint, new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$azure$2f$core$2d$auth$2f$dist$2f$esm$2f$azureKeyCredential$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AzureKeyCredential"](token));
        const response = await client.path("/chat/completions").post({
            body: {
                messages: [
                    {
                        role: "system",
                        content: "Ești Alex, un nutriționist prietenos și empatic care vorbește natural cu utilizatorii."
                    },
                    {
                        role: "user",
        ...
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$azure$2d$rest$2f$ai$2d$inference$2f$dist$2f$esm$2f$isUnexpected$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isUnexpected"])(response)) {
            console.error("GitHub AI API error:", response.body.error);
            throw new Error("API error");
        }
        return response.body.choices[0]?.message?.content || "Îmi pare rău, nu am putut răspunde acum. Cum te simți?";
    } catch (error) {
        console.error("GitHub AI API error:", error);
        if (detectedFoods.length > 0) {
            return `Văd că ai mâncat ${detectedFoods.map((f)=>f.name).join(", ")}. Cum te simți după masă? Ai vrea să vorbim despre asta?`;
        }
...
async function POST(request) {
    try {
        ...
        const aiResponse = await callGitHubAIForNaturalChat(message, detectedFoods, profile);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e14a8f6b._.js.map